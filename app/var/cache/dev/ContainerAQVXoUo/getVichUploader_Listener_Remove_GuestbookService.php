 ...
 */
class getVichUploader_Listener_Remove_GuestbookService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'vich_uploader.listener.remove.guestbook' shared service.
     *
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        if (isset($container->privates['vich_uploader.listener.remove.guestbook'])) {
            return $container->privates['vich_uploader.listener.remove.guestbook'];
        }

        return $container->privates['vich_uploader.listener.remove.guestbook'] = new \Vich\UploaderBundle\EventListener\Doctrine\RemoveListener('guestbook', ($container->privates['vich_uploader.adapter.orm'] ?? ($container->privates['vich_uploader.adapter.orm'] = new \Vich\UploaderBundle\Adapter\ORM\DoctrineORMAdapter())), ($container->privates['vich_uploader.metadata_reader'] ?? $container->load('getVichUploader_MetadataReaderService')), $a);
    }
}
