...
class App_KernelDevDebugContainer extends Container
{
    ...
    public function __construct(array $buildParameters = [], $containerDir = __DIR__)
    {
        ...
        $this->fileMap = [
            ...
            'App\\Controller\\GuestbookController' => 'getGuestbookControllerService',
            ...
            'Vich\\UploaderBundle\\Naming\\SmartUniqueNamer.guestbook' => 'getSmartUniqueNamer_GuestbookService',
    ...
    {
        return $this->privates['cache.annotations'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('qD0me17TPJ', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    {
        $this->privates['monolog.handler.main'] = $instance = new \Monolog\Handler\StreamHandler((\dirname(__DIR__, 6).'/log/dev.log'), 200, true, NULL, false);
        ...
        return [
            ...
            'vich_uploader.mappings' => [
                'guestbook' => [
                    ...
                    'upload_destination' => (\dirname(__DIR__, 4).'/public/images/guestbook'),
                    'namer' => [
                        'service' => 'Vich\\UploaderBundle\\Naming\\SmartUniqueNamer.guestbook',
                        'options' => [
