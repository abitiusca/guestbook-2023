 ...
 */
class getVichUploader_Listener_Upload_GuestbookService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'vich_uploader.listener.upload.guestbook' shared service.
     *
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        if (isset($container->privates['vich_uploader.listener.upload.guestbook'])) {
            return $container->privates['vich_uploader.listener.upload.guestbook'];
        }

        return $container->privates['vich_uploader.listener.upload.guestbook'] = new \Vich\UploaderBundle\EventListener\Doctrine\UploadListener('guestbook', ($container->privates['vich_uploader.adapter.orm'] ?? ($container->privates['vich_uploader.adapter.orm'] = new \Vich\UploaderBundle\Adapter\ORM\DoctrineORMAdapter())), ($container->privates['vich_uploader.metadata_reader'] ?? $container->load('getVichUploader_MetadataReaderService')), $a);
    }
}
