...
class getGuestbookControllerService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).'/src/Controller/GuestbookController.php';

        $container->services['App\\Controller\\GuestbookController'] = $instance = new \App\Controller\GuestbookController();

        $instance->setContainer(($container->privates['.service_locator.mx0UMmY'] ?? $container->load('get_ServiceLocator_Mx0UMmYService'))->withContext('App\\Controller\\GuestbookController', $container));
