 ...
 */
class getVichUploader_Listener_Clean_GuestbookService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'vich_uploader.listener.clean.guestbook' shared service.
     *
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        if (isset($container->privates['vich_uploader.listener.clean.guestbook'])) {
            return $container->privates['vich_uploader.listener.clean.guestbook'];
        }

        return $container->privates['vich_uploader.listener.clean.guestbook'] = new \Vich\UploaderBundle\EventListener\Doctrine\CleanListener('guestbook', ($container->privates['vich_uploader.adapter.orm'] ?? ($container->privates['vich_uploader.adapter.orm'] = new \Vich\UploaderBundle\Adapter\ORM\DoctrineORMAdapter())), ($container->privates['vich_uploader.metadata_reader'] ?? $container->load('getVichUploader_MetadataReaderService')), $a);
    }
}
