...
class getDoctrine_Dbal_DefaultConnectionService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->services['doctrine.dbal.default_connection'] = (new \Doctrine\Bundle\DoctrineBundle\ConnectionFactory([]))->createConnection(['url' => $container->getEnv('resolve:DATABASE_URL'), 'driver' => 'pdo_mysql', 'host' => 'localhost', 'port' => NULL, 'user' => 'root', 'password' => NULL, 'driverOptions' => [], 'defaultTableOptions' => []], $a, new \Symfony\Bridge\Doctrine\ContainerAwareEventManager(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($container->getService, [
            ...
            'vich_uploader.listener.clean.guestbook' => ['privates', 'vich_uploader.listener.clean.guestbook', 'getVichUploader_Listener_Clean_GuestbookService', true],
            'vich_uploader.listener.remove.guestbook' => ['privates', 'vich_uploader.listener.remove.guestbook', 'getVichUploader_Listener_Remove_GuestbookService', true],
            'vich_uploader.listener.upload.guestbook' => ['privates', 'vich_uploader.listener.upload.guestbook', 'getVichUploader_Listener_Upload_GuestbookService', true],
        ], [
            'doctrine.orm.default_listeners.attach_entity_listeners' => '?',
            'doctrine.orm.listeners.doctrine_dbal_cache_adapter_schema_subscriber' => '?',
            'doctrine.orm.listeners.doctrine_token_provider_schema_subscriber' => '?',
            'doctrine.orm.listeners.pdo_cache_adapter_doctrine_schema_subscriber' => '?',
            'vich_uploader.listener.clean.guestbook' => '?',
            'vich_uploader.listener.remove.guestbook' => '?',
            'vich_uploader.listener.upload.guestbook' => '?',
        ]), [0 => 'vich_uploader.listener.clean.guestbook', 1 => 'doctrine.orm.listeners.doctrine_dbal_cache_adapter_schema_subscriber', 2 => 'doctrine.orm.listeners.pdo_cache_adapter_doctrine_schema_subscriber', 3 => 'doctrine.orm.listeners.doctrine_token_provider_schema_subscriber', 4 => 'vich_uploader.listener.remove.guestbook', 5 => 'vich_uploader.listener.upload.guestbook', 6 => [0 => [0 => 'loadClassMetadata'], 1 => 'doctrine.orm.default_listeners.attach_entity_listeners']]), []);
    }
}
